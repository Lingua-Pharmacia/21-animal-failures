...
let lifetimeScore = parseInt(localStorage.getItem('animalFailuresScore')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedAnimalFailuresLessons')) || [];
if(ptsVal) ptsVal.innerText = lifetimeScore;

let wordBucket = []; let currentQ = 0; let attempts = 0; let totalScore = 0; let firstCard = null;

const stations = [
    {file:"01_CobraEffect.mp3", title:"1. The Cobra Effect"},
    {file:"02_HanoiRatBounty.mp3", title:"2. The Hanoi Rat Bounty"},
    {file:"03_BarrelOfRats.mp3", title:"3. The Barrel of Rats"},
    {file:"04_BattleOfPelusium.mp3", title:"4. The Battle of Pelusium"},
    {file:"05_BlackCatsPlague.mp3", title:"5. Black Cats and the Plague"},
    {file:"06_FourPestsCampaign.mp3", title:"6. The Four Pests Campaign"},
    {file:"07_GreatEmuWar.mp3", title:"7. The Great Emu War"},
    {file:"08_OperationCatDrop.mp3", title:"8. Operation Cat Drop"},
    {file:"09_CaneToad.mp3", title:"9. The Cane Toad"},
    {file:"10_MongooseAndRat.mp3", title:"10. The Mongoose and the Rat"},
    {file:"11_TibblesTheCat.mp3", title:"11. Tibbles the Cat"},
    {file:"12_VulturesAndRabies.mp3", title:"12. Vultures and Rabies"},
    {file:"13_PassengerPigeon.mp3", title:"13. The Passenger Pigeon"},
    {file:"14_EscobarHippos.mp3", title:"14. The Escobar Hippos"},
    {file:"15_KillerBees.mp3", title:"15. The Killer Bees"},
    {file:"16_RabbitProofFence.mp3", title:"16. The Rabbit-Proof Fence"},
    {file:"17_PigWar.mp3", title:"17. The Pig War"},
    {file:"18_GhostNets.mp3", title:"18. Ghost Nets in the Ocean"},
    {file:"19_BloodBounty.mp3", title:"19. The Blood Bounty"},
    {file:"20_GoatAndGalapagos.mp3", title:"20. The Goat and the Galapagos"},
    {file:"21_AsianCarp.mp3", title:"21. The Asian Carp"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('animalFailuresScore', lifetimeScore);
    const fn = decodeURIComponent(audio.src.split('/').pop());
    if(!completedLessons.includes(fn)) { 
        completedLessons.push(fn); 
        localStorage.setItem('completedAnimalFailuresLessons', JSON.stringify(completedLessons)); 
    }
    renderGrid(); 
